...
@section('content')
  ...
  <!-- chart js -->
  <script src="{{ url('/') }}/gentella-js/moment/moment.min.js"></script>
  ...
  <!-- easypie -->
  <script src="{{ url('/') }}/gentella-js/easypie/jquery.easypiechart.min.js"></script>
  <!-- pace -->
  ...
  <script>
    //@code_start
    $(function() {
      $.getJSON('{{ url('/') }}/gentella-js/maps/us-unemployment.json', function(data) {
        var val = 2009;
