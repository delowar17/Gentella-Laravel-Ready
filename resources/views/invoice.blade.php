                  ...
                  <section class="content invoice">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-6">
                        ...
                        <img src="{{ url('/') }}/gentella-images/visa.png" alt="Visa">
                        <img src="{{ url('/') }}/gentella-images/mastercard.png" alt="Mastercard">
                        <img src="{{ url('/') }}/gentella-images/american-express.png" alt="American Express">
                        <img src="{{ url('/') }}/gentella-images/paypal2.png" alt="Paypal">
