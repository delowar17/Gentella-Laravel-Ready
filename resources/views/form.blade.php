...
@section('content')
  ...
  <!-- tags -->
  <script src="{{ url('/') }}/gentella-js/tags/jquery.tagsinput.min.js"></script>
  <!-- switchery -->
  <script src="{{ url('/') }}/gentella-js/switchery/switchery.min.js"></script>
  <!-- daterangepicker -->
  ...
  <!-- richtext editor -->
  <script src="{{ url('/') }}/gentella-js/editor/bootstrap-wysiwyg.js"></script>
  <script src="{{ url('/') }}/gentella-js/editor/external/jquery.hotkeys.js"></script>
  <script src="{{ url('/') }}/gentella-js/editor/external/google-code-prettify/prettify.js"></script>
  <!-- select2 -->
  <script src="{{ url('/') }}/gentella-js/select/select2.full.js"></script>
  <!-- form validation -->
  <script type="text/javascript" src="{{ url('/') }}/gentella-js/parsley/parsley.min.js"></script>
  <!-- textarea resize -->
  <script src="{{ url('/') }}/gentella-js/textarea/autosize.min.js"></script>
  <script>
    autosize($('.resizable_textarea'));
  </script>
  <!-- Autocomplete -->
  <script type="text/javascript" src="{{ url('/') }}/gentella-js/autocomplete/countries.js"></script>
  <script src="{{ url('/') }}/gentella-js/autocomplete/jquery.autocomplete.js"></script>
  <!-- pace -->
