...
@section('content')
                ...
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <div class="img-container">
                      <img src="{{ url('/') }}/gentella-images/picture2.jpg" alt="Picture">
                    </div>
                  </div>
                  <div class="col-md-3">
  ...
  <!-- input mask -->
  <script src="{{ url('/') }}/gentella-js/input_mask/jquery.inputmask.js"></script>
  <!-- knob -->
  <script src="{{ url('/') }}/gentella-js/knob/jquery.knob.min.js"></script>
  <!-- range slider -->
  <script src="{{ url('/') }}/gentella-js/ion_range/ion.rangeSlider.min.js"></script>
  <!-- color picker -->
  <script src="{{ url('/') }}/gentella-js/colorpicker/bootstrap-colorpicker.min.js"></script>
  <script src="{{ url('/') }}/gentella-js/colorpicker/docs.js"></script>

  <!-- image cropping -->
  <script src="{{ url('/') }}/gentella-js/cropping/cropper.min.js"></script>
  <script src="{{ url('/') }}/gentella-js/cropping/main2.js"></script>
  <!-- pace -->
