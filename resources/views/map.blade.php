...
@section('content')
      ...
      <head>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="http://vodacom.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/daterangepicker-bs3.css" />

        <link rel="stylesheet" href="http://vodacom.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/colorbox.css" />
      ...
      <body data-twttr-rendered="true">
        ...
        <head>
          ...
          <link rel="stylesheet" type="text/css" media="all" href="http://tigo.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/daterangepicker-bs3.css" />

          <link rel="stylesheet" href="http://tigo.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/colorbox.css" />
        ...
        <body data-twttr-rendered="true">
          ...
          <script type="text/javascript">
            var script = '<script type="text/javascript" src="http://tigo.registersim.com/assets/{{ url('/') }}/gentella-js/src/markerclusterer';
          ...
          <script src="http://vodacom.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/jquery.masonry.min.js"></script>
          <script>
            $(function() {
          ...
          <script src="http://vodacom.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/jquery.colorbox.js"></script>
          <script>
          ...
          <script type="text/javascript" src="http://vodacom.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/moment.min.js"></script>
          <script type="text/javascript" src="http://vodacom.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/daterangepicker.js"></script>
          <script type="text/javascript">
            $(document).ready(function() {
          ...
          <script type="text/javascript" src="http://vodacom.registersim.com/assets/dashboard/{{ url('/') }}/gentella-js/highcharts.js"></script>
